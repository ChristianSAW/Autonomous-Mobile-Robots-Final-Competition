function vj = VisibilityJudgeWallCircularGrid(map,point1,point2,robotRad)
...
%                         break
%                     else
%                         wm1 = withinMapCircular(mapLimits,point1,robotRad);
...
% for i = 1:size(map,1)
%     [isect,x,y,ua]= intersectPoint(point1(1),point1(2),point2(1),point2(2),map(i,1),map(i,2),map(i,3),map(i,4));
%     if isect == 1
%         vj =0;
%         break
%     end
